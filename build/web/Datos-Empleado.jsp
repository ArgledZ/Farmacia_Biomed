                    ...
                    <div class="card-body">
                        <table id="tablaEmpleados" class="table table-bordered table-hover">
                            ...
                            <tbody id="tbempleados">
                                <%if(session.getAttribute("listaEmpleados") != null){
                                              List<Empleado> lstEmpleados = (List<Empleado>)session.getAttribute("listaEmpleados");
                                              for(int i=0; i < lstEmpleados.size(); i++){
                                                  Empleado emple = lstEmpleados.get(i);
                                %>

                                <tr data-idcodigo="<%=emple.getId_persona()%>" data-iddocumento="<%=emple.getTipodocumento().getId_tipo_documento()%>" data-idcargo="<%=emple.getCargo().getId_cargo()%>" data-idestado="<%=emple.getEstadoempleado().getId_estadoempleado()%>" >
...
%>
                                    ...
                                    <td><%=emple.getCargo().getDes_cargo()%></td>
                                    <td><%=emple.getEstadoempleado().getDes_estadoempleado()%></td>
                                    <td><%=emple.getUsuario()%></td>
                                    <td><%=emple.getClave()%></td>
