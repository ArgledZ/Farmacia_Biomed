<%-- 
    Document   : Datos-Proveedor
    Created on : 21/06/2022, 09:09:33 PM
    Author     : gcamo
--%>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info alert-styled-left text-blue-800 content-group d-flex justify-content-between">
                        <div> <span class="btn text-semibold text-light"><i class="icon fas fa-user"></i>Lista de Proveedores</span></div>
                        <div><button type="button" class="btn btn-outline-light btn-block" data-toggle="modal" data-target="#modal-nuevo"><i class="fa fa-user-plus"></i> Nuevo Proveedor</button></div>
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tablaProveedor" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Nombres</th>
                                    <th>Apellidos</th>
                            ...
                            <tbody id="tbProveedor">
                                <%if(session.getAttribute("listaProveedores") != null){
                                              List<Proveedor> lstProveedor = (List<Proveedor>)session.getAttribute("listaProveedores");
                                              for(int i=0; i < lstProveedor.size(); i++){
                                                  Proveedor prov = lstProveedor.get(i);
                                %>

                                <tr data-idcodigo="<%=prov.getId_persona()%>" data-iddocumento="<%=prov.getTipodocumento().getId_tipo_documento()%>">
                                    <td><%=prov.getNom_persona()%></td>
                                    <td><%=prov.getApe_persona()%></td>
                                    <td><%=prov.getTipodocumento().getDes_tipo_documento()%></td>
                                    <td><%=prov.getNumero_identicacion()%></td>
                                    <td><%=prov.getFecha_naci_persona()%></td>
                                    <td>
                                        <%
                                            ...
                                            String string = prov.getFecha_naci_persona();
                                    ...
                                    <td><%=prov.getNacioalidad_persona()%></td>
                                    <td><%=prov.getEmpresa_persona()%></td>
                                    <td><%=prov.getCorreo_persona()%></td>
                                    <td><%=prov.getTelf_persona()%></td>
                                    <td><%=prov.getDir_persona()%></td>
                                    <td><%=prov.getSex_persona()%></td>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <!-- small box -->
                    ...
                    <label for="uname" class="font-weight-light">Tel�fono</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
          ...
          <div class="col-lg-3 col-6">
            <!-- small box -->
                    ...
                    <label for="uname" class="font-weight-light">Direcci�n</label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
...
<script>
    ...
    $('#tbProveedor').on('click', 'tr td', function (evt) {
  ...
  function Actualizar() {
        ...
        Swal.fire({
            ...
            if (result.value) {
               ...
               var clave = document.getElementById("txtclave").value;
                ...
                jQuery.ajax({
                    url: 'ControladorProveedor?menu=Proveedor&accion=Editar&id=' + id +
                    ...
                    beforeSend: function () {
                        Swal.fire({
                            html: 'El registro se est� Modificando, espere un momento por favor....<br><i class="fa fa-spinner fa-pulse" style="font-size:50px;margint-top:10px;"></i> ',
                            imageUrl: 'ICONOS/logobiomed.png',
                            imageAlt:      'Biomed',
                            imageWidth: '100px',
                            allowOutsideClick: false,
    ...
    function Agregar() {
        ...
        Swal.fire({
          ...
          text:"Los campos no pueden estar vac�os",
          type: 'warning'
                ...
                jQuery.ajax({
                    url: 'ControladorProveedor?menu=Proveedor&accion=Agregar&nom=' + nombres +
                    ...
                    beforeSend: function () {
                        Swal.fire({
                            html: 'El registro se est� Insertando, espere un momento por favor....<br><i class="fa fa-spinner fa-pulse" style="font-size:50px;margint-top:10px;"></i> ',
                            imageUrl: 'ICONOS/logobiomed.png',
                            imageAlt: 'Biomed',
                            imageWidth: '100px',
                            allowOutsideClick: false,
                ...
                $('#modal-nuevo').removeClass('show');
                        ...
                        Swal.fire({
                            title: '<strong>Felicidades</strong>',
                            text: "El Registro se ha insertado con �xito",
                            type: 'success',
                            allowOutsideClick: false,
                            showCancelButton: false,
                            confirmButtonColor: '#3085d6',
                         ...
                         Swal.fire({
                            ...
                            text: "El Registro con el mismo numero de identificaci�n ya existe",
                            type: 'error',
                            allowOutsideClick: false,
                            showCancelButton: false,
                            confirmButtonColor: '#3085d6',
    ...
    function Eliminar() {
        ...
        Swal.fire({
            ...
            text: 'El dato ser� quitado de la lista',
            // type: 'question',
            imageUrl: 'ICONOS/logobiomed.png',
            imageAlt: 'Biomed Centro Medico',
            imageWidth: '100px',
            ...
            if (result.value) {
                ...
                jQuery.ajax({
                    url: 'ControladorProveedor?menu=Proveedor&accion=Eliminar&id=' + id,
                    type: 'POST',
                    dataType: 'html',
                    data: $("#frmodi").serialize(),
                    beforeSend: function () {
                        Swal.fire({
                            html: 'El registro se est� eliminando, espere un momento por favor....<br><i class="fa fa-spinner fa-pulse" style="font-size:50px;margint-top:10px;"></i> ',
                            imageUrl: 'ICONOS/logobiomed.png',
                            imageAlt: 'Biomed',
                            imageWidth: '100px',
                            allowOutsideClick: false,
